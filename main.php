...
<body>
    <div class="header">
        ...
        <div class="nav">
            ...
            <a href="client/connexion.php">log-in</a>
        </div>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://frontmediaspot.com/wp-content/uploads/2023/07/Best-TV-Shows-All-Time-scaled.jpg" class="d-block w-100" alt="...">
            </div>
            <!-- Add more carousel items as needed -->
            <div class="carousel-item">
                <img src="https://static1.colliderimages.com/wordpress/wp-content/uploads/2020/10/best-tv-shows-to-binge-watch-social.png" class="d-block w-100" alt="...">
            </div>
        </div>
        ...
        <?php foreach ($movies as $movie): ?>
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <a href="user.php?film_id=<?= $movie['id'] ?>" class="btn btn-primary"><i class="fas fa-info-circle"></i> View Details</a>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
